      ...
      <div className="container mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="mt-20 bg-card-dark rounded-lg shadow-2xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            {/* We add 'title-container' to this div to enable the hover effect */}
            <div className="p-8 md:p-12 flex flex-col justify-center text-center md:text-left title-container">
              <h2 className="text-2xl md:text-3xl font-bold text-dorado-el-pollo mb-4">
                ¿Quieres ser parte de la familia?
              </h2>

              {/* The paragraph now uses the 'subtitle' class for the hover effect */}
              <p className="text-white mb-8 subtitle">
            ...
            <div className="relative min-h-[300px] md:min-h-full">
              <Image
                ...
                alt="Mascota de El Pollo Supremo"
                fill
